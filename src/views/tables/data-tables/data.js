...
import { MoreVertical, Edit, Trash2, FileText, Archive, Trash } from 'react-feather'
...
// Table Reward Offer
export const rewardOfferColums = [
  {
    name: 'Name',
    sortable: true,
    minWidth: '30px',
...

  {
    ...
    cell: row => {
      return (
        <Badge color={ActiveStatus[row.status].color} pill>
          {ActiveStatus[row.status].title}
        </Badge>
      )
    }
  },
